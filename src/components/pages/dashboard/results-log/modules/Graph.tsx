      ...
      <div className="justify-center items-center pt-8 pb-16 ">
        {graph === 'BarChart1' ? (
          <div className="grid grid-rows-6">
            <div className="mb-6">
              <p className="font-semibold text-main_gray">
                Motores No Producidos
              </p>
              <p className="font-semibold text-main_blue_dark text-5xl ">
                589
              </p>
            ...
            <div className="row-span-5 max-h-[1200px]">
              <ResponsiveContainer height="100%" width="100%">
                <BarChart data={data}>
                  ...
                  <Legend />
                  <Bar
                    dataKey="Motores_No_Producidos"
                    stackId="a"
                    fill={COLORS[3]}
                  />
                  <Bar
                    dataKey="Motores_Producidos"
                    stackId="a"
                    fill={COLORS[1]}
                  />
                </BarChart>
          ...
          <div className="grid grid-cols-2">
            ...
            <div className="grid grid-rows-2 ">
              <div className="grid grid-cols-3  grid-rows-3 h-fit items-center">
                ...
                <p className="font-semibold text-main_gray col-span-2">
                  Motores No Producidos
                </p>
                <p className="font-semibold text-main_blue_dark text-5xl">
                  595
                </p>
                <p className="font-semibold text-main_blue_dark text-5xl col-span-2 ">
                  4122
                </p>
